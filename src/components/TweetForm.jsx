...
const TweetForm = () => {
  const {setTweetText,tweetText, sendTweet, handleImageChange, previewURL} = useData()
  return (
    ...
    { previewURL && <img className="w-[90%] h-[200px] object-contain" src={previewURL} alt="tweet-pic" />}
